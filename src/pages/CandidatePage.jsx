  ...
  const handleDownloadResume = async (candidate) => {
    try {
      ...
      const response = await axios.get(
        `${BASE_API_URL}/candidates/${candidate._id}/resume`,
        {
          responseType: "blob",
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const handleStatusChange = async (candidateId, newStatus) => {
    try {
      ...
      const response = await axios.patch(
        `${BASE_API_URL}/candidates/${candidateId}`,
        { status: newStatus },
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
      ...
      const errorMessage =
        error.response?.data?.message ||
        "Failed to update candidate status or move to employee. Please try again.";
      setError(errorMessage);
              ...
              <tr>
                ...
                >
                  ...
                  {error
                    ...
                    : "Try adding a new candidate or adjusting the filters."}
                </td>
              </tr>
            ) : (
                ...
                <div className="form-group">
                  <div className="floating-label">
                    <input
                      ...
                      onBlur={() =>
                        handleBlur("fullName", newCandidate.fullName)
                      }
                      required
                      disabled={isLoading}
                    />
                    <span
                      className={
                        focusedFields.fullName || newCandidate.fullName
                          ? "label-active"
                          : ""
                      }
                    >
                ...
                <div className="form-group">
                  <div className="floating-label">
                    <input
                      ...
                      onBlur={() => handleBlur("email", newCandidate.email)}
                      required
                      disabled={isLoading}
                    />
                    <span
                      className={
                        focusedFields.email || newCandidate.email
                          ? "label-active"
                          : ""
                      }
                    >
                ...
                <div className="form-group">
                  <div className="floating-label">
                    <input
                      ...
                      onBlur={() => handleBlur("phone", newCandidate.phone)}
                      required
                      disabled={isLoading}
                    />
                    <span
                      className={
                        focusedFields.phone || newCandidate.phone
                          ? "label-active"
                          : ""
                      }
                    >
                ...
                <div className="form-group">
                  <div className="floating-label">
                    <input
                      ...
                      onBlur={() =>
                        handleBlur("experience", newCandidate.experience)
                      }
                      required
                      disabled={isLoading}
                    />
                    <span
                      className={
                        focusedFields.experience || newCandidate.experience
                          ? "label-active"
                          : ""
                      }
                    >
        ...
        >
          ...
          >
            ...
            <div className="delete-content">
              <p>
                Are you sure you want to delete {candidateToDelete?.fullName}?
              </p>
